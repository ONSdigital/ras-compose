...
# 2.3) GET (/collectioninstrument/reference/{reference}) using a reference with a non-ASCII character e.g. À
...
#  Scenario Outline: Collection Instrument <identifier> domain name is incorrect
...
#  @connect_to_database
#  Scenario Outline: Obtain collection instrument data by identifier
